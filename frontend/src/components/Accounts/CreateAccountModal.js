...
import { X, Plus, Building2, FileText } from "lucide-react"
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-emerald-100 text-sm">Create a new financial account</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors duration-200"
                    placeholder="0.00"
                    step="0.01"
                    required
                  />
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors duration-200 resize-none"
            ...
            <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
              ...
              <button
                type="submit"
                className="px-6 py-3 bg-emerald-600 text-white font-semibold rounded-lg hover:bg-emerald-700 focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition-all duration-200 shadow-lg"
              >
                Create Account
              </button>
            </div>
